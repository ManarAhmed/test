...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Ewest Egypt</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We work in Embedded system and Web development.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary" style="color: #946d70;"></i>
                        <i class="fa fa-rocket fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="service-heading">Embedded System Projects</h4>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary" style="color: #f05325;"></i>
                        <i class="fa fa-laptop fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="service-heading">Development</h4>
                    <p class="text-muted">We empower our clients with an easy to use websites which is constantly evolving and can be fully customized. We introduce highly robust, highly flexible solution. </p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary" style="color: #f05325;"></i>
                    ...
                    <p class="text-muted">We'll make your web page look good on all devices (desktops, tablets, and phones).</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary" style="color: #f05325;"></i>
                    ...
                    <p class="text-muted">Our websites as much as possible are free from security threads. As our mission is to take care of our customers data and business.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>xxxxxxxxx</h4>
                        <p class="text-muted">xxxxxxxxxxx</p>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>xxxxxxxxxxxx</h4>
                        <p class="text-muted">xxxxxxxxxxxxxxxxxx</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <h4>xxxxxxxxxxxxx</h4>
                        <p class="text-muted">xxxxxxxxxxxxx</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-facebook"></i></a>
    ...
    <aside class="clients">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="resources/mg/logos/designmodo.jpg" class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">You are welcome at any time</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="index.php" name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-center">
                                <h2 class="section-heading" style="font-size: 30px;">Telephone</h2>
                                <h3 class="section-subheading text-muted" style="font-size: 25px; color: #ffffff;">xx-xxxxxx</h3>
                                <h2 class="section-heading" style="font-size: 30px;">Address</h2>
                                <h3 class="section-subheading text-muted" style="font-size: 25px; color: #ffffff;">Egypt- Alexandria- Al Bitash new street</h3>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <!--<input type="button" name="submit" value="Send Message" class="btn btn-xl">-->
                                <input type="submit" name="hi" value="hi">
                                <button type="submit" name="smit" value="1" class="btn btn-xl">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Ewest Egypt 2016</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
